...
export const EFFECTS: Record<string, EffectRenderer> = { ...mechanicsEffects, ...thermalEffects, ...circuitEffects, ...magneticEffects, ...waveEffects, ...opticsEffects, ...quantumEffects, ...relativityEffects };
