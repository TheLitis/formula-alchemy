...
export function Inspector({ open, onClose, onBook }: {
    ...
    <div className="inspector-body">{ids.length > 1 ? <>
      ...
      <p className="muted">Тяните любой выделенный объект — перемещается вся группа. R поворачивает её на 15°, Shift+R — в обратную сторону. Ctrl-клик убирает или добавляет один объект.</p>
