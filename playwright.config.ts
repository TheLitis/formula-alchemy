...
export default defineConfig({
    ...
    use: { baseURL: 'http://127.0.0.1:4173/formula-alchemy/', trace: 'retain-on-failure', screenshot: 'only-on-failure' },
    ...
    webServer: { command: 'npm run preview:pages', url: 'http://127.0.0.1:4173/formula-alchemy/', reuseExistingServer: !process.env.CI, timeout: 60000 },
});
